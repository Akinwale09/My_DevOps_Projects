...
![KubernetesArchitecture](./img/01.%20kubernetes-architecture.png)
...
![KubernetesMasterNode](./img/02.%20k8s-diagram.jpg)
...
![windowTerminal](./img/03.%20terminal.gif)

![Terminal](./img/05.%20Terminal.png)

ii. Install Minikube

`choco install minikube`

![ChocoleteyInstalled](./img/04.%20InstallMiniCube.png)

![ChocoInstalled](./img/06.%20ChocoInstalled.png)
...
![DockerDesktop](./img/07.%20DockerDesktop.png)

iv. Run the command below to start minikube using docker as the driver

`minikube start --driver=docker`

![StartMiniKube](./img/08.%20StartMiniKube.png)
...
![UbuntuTerminal](./img/09.%20Ubuntuterminal.png)
...
![AptUpdate](./img/10.%20sudoUpdate.png)
...
![certificate](./img/11.%20Certificate.png)
...
![Keyrings](./img/12.%20keystrings.png)
...
![Dockergpg](./img/13.%20Dockergpg.png)
...
![Dockergpg](./img/14.%20Dockergpg.png)
...
`echo \
  ...
  ![RepoAddSource](./img/15.%20Repoaddsource.png)
 ...
 ![sudoupdate](./img/16.%20Update.png)
...
![instalDocker](./img/17.%20InstallDocker.png)
![DockerInstall](./img/18.%20DockerInstall.png)

**Verify that docker has been successfully installed**

`sudo systemctl status docker`

![DockerRunning](./img/19.%20DockerRunning.png)

iii. Install minikube

`curl -LO https://storage.googleapis.com/minikube/releases/latest/minikube_latest_amd64.deb`

![InstallMiniKube](./img/20.%20InstallMiniKube.png)

If you get an error after running the command above, reach out to the technical support.

`sudo dpkg -i minikube_latest_amd64.deb`

![MinikubeInstalled](./img/21.%20MiniKubeInstalled..png)

iv. Start minikube

`minikube start --driver=docker `

![StartMinikubedocker](./img/22.%20MiniKubeStart.png)
...
![KubecltInstalled](./img/23.%20KubectlInstalled.png)
