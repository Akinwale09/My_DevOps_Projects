...
1. Create a playbook file for backup:
    ...
    ![BackupFile](./img/12.%20backupfile.png)

2. Add the following playbook content:

    ![BackUpConfiguration](./img/13.%20BackupConfiguration.png)
...
3. Replace `/path/to/files` with the path of the files you want to back up. 
    ...
    ![BackUpFile](./img/14.%20FilePath.png)

    ![Configfile](./img/15.%20BackupConfig.png)
...
1. Create a playbook file for restoration:
    ...
    ![RestoreFile](./img/17.%20RestoreFile.png)

2. Add the following playbook content:

    ![BackUpRestore](./img/18.%20BackupRestore.png)

    ![RestoreFile](./img/19.%20RestoreConfig.png)
...
1. Run the backup playbook:
    ...
    ![AnsibleBackup](./img/20.%20BackUpTest.png)
...
2. Verify the backup directory and files on the target server:
    ...
    ![BackupDir](./img/21.%20BackupDir.png)
