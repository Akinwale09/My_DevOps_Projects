...
![sampleyamlfile](./img/01.%20yaml.png)
...
![KubeDeployment](./img/09.%20kubectldeployment.png)

if the code return error, start Minikube using:

`minikube start --driver=docker`

![StartMiniKbue](./img/08.%20StartMinikube.png)


`kubectl expose deployment hello-minikube --type=NodePort --port=8080`

![ExposeKubernetersDeployment](./img/10.%20KubeExposed.png)

The command above exposes the Kubernetes Deployment named "hello-minikube" as a NodePort service on port 8080

`kubectl get services hello-minikube`

![KubeLunch](./img/11.%20KubernetersLunch.png)
...
![YAMLFile](./img/12.%20Yamlfile.png)
...
![servicesyaml](./img/13.%20yamlservicefile.png)
...
![KubeDeplyment](./img/14.%20deploy.png)
...
![VerifyDeployment](./img/15.%20verifydeplyment.png)

vi. Access your deployment on web browser

`minikube service my-nginx-service --url`

![AccessDeplyment](./img/16.%20AccessDeplyment.png)

![WebAccess](./img/17.%20WebAccess.png)
