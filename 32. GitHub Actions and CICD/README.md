...
![GitAction](./img/01.%20orchestra-analogy.png)
...
1. #### YAML Syntax for Workflows:
 ...
 - Example snippet:
    ...
    ![YAMLFile](./img/02.%20YAMLFile.png)
...
1. **Defining the Build Job:**
  ...
  - This job is responsible for building our code.
    ...
    ![code](./img/04.%20code.png)
    ![YMLfile](./img/03.%20mainYML.png)
...
2. **Adding Build Steps:**
  ...
  - Here, we add three steps: checking out the code, installing dependencies, and running the build script.
    ...
    ![Buildsteps](./img/05.%20Steps.png)
    ![StepsAdded](./img/06.%20Steps.png)
...
1. **Adding Test Steps:**
 ...
 - This ensures that our code is not only built but also passes all the tests.
    ...
    ![TEstSteps](./img/07.%20Test%20Steps.png)
    ![CorrectIdentedWorkFlow](./img/08.%20CorrectIdentedWorkFlow.png)
...
1. **Using Environment Variables:**
 ...
 - They allow us to dynamically pass configuration and settings.
    ...
    ![EnvVariable](./img/09.%20environmentVar.png)
...
2. **Working with Secrets:**
 ...
 - Ideal for storing sensitive data like access tokens, passwords, etc.
    ...
    ![WorkinfWithSecrete](./img/10.%20UsingSecrete.png)

3. **Conditional Execution:**

 - You can control when jobs, steps, or workflows run based on conditions.

    ![UsingCondition](./img/11.%20usingCondition.png)

4. **Using Outputs and Inputs between Steps:**

 - Share data between steps in a job using outputs.

    ![UsingSharedDataBtw](./img/12.%20ShareData.png)

The Formatted Code

![FormattedCode](./img/13.%20FormattedCode.png)
![FormattedCode](./img/14.%20FormattedCode.png)
![FormattedCode](./img/15.%20FormattedCode.png)
...
![MatrixBuild](./img/16.%20MatrixBuild.png)
![MatrixBuild](./img/17.%20MatrixBuild.png)

![MatrixDeploy](./img/18.%20CIDeploy.png)
